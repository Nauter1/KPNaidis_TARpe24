...
public partial class StartPage : ContentPage
{
	...
	public List<string> LeheNimed = new List<string>() { "LanguageSwap","Tekst", "Kujund", "Timer", "Foor", "DateTime", "Stepper", "RGB Slider", "Snowman", "PopUp", "Grid", "Trips-Traps-Trull", "Kontakt Andmed", "Dynamic List", "Riik Valik", "KarusselPages", "InteraktiivneKarussel", "Mälumäng" };
	public StartPage()
	{
		// Title = "Avaleht";
